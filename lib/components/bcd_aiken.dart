...
class BCDAikenSumConverter extends StatefulWidget {
  @override
  _BCDAikenSumConverterState createState() => _BCDAikenSumConverterState();
}

class _BCDAikenSumConverterState extends State<BCDAikenSumConverter> {
  String firstNumber = "";
  String secondNumber = "";
  String fBcd;
  String sBcd;
  ...
  String inputToBcd(String i) {
    ...
    List digits = i.characters.map((digit) {
      int.parse(digit) > 5
          ? digit = (int.parse(digit) + 6).toString()
          : digit = digit;
